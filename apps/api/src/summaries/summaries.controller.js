...
let SummariesController = (() => {
    let _classDecorators = [Controller('summaries'), UseGuards(SupabaseAuthGuard)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _instanceExtraInitializers = [];
    let _getSummary_decorators;
    var SummariesController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _getSummary_decorators = [Get(':meetingId')];
            ...
            SummariesController = _classThis = _classDescriptor.value;
    ...
    return SummariesController = _classThis;
})();
export { SummariesController };
