...
let WebhooksService = (() => {
    ...
    var WebhooksService = class {
        ...
        async handleGoogleCalendarWebhook(channelId, resourceId) {
            ...
            if (watch.resourceId !== resourceId) {
                console.warn(`[Webhooks] Resource ID mismatch for channel ${channelId}: expected ${watch.resourceId}, got ${resourceId}`);
