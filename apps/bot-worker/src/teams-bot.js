...
async function saveScreenshot(page, filename) {
    try {
        ...
        console.error(`[teams-bot] Failed to save screenshot "${filename}":`, err.message);
    }
}
// ─────────────────────────────────────────────────────────────────────────────
// Main
...
export async function runTeamsBot() {
    ...
    try {
        ...
        console.error('[teams-bot] Navigation failed:', err.message);
    ...
    try {
        ...
        console.error('[teams-bot] Timed out waiting to join:', err.message);
    ...
    const checkInterval = setInterval(async () => {
        try {
            const leaveVisible = await page.isVisible('[data-tid="hangup-button"]').catch(() => false) ||
...
// Guest bypass
// ─────────────────────────────────────────────────────────────────────────────
async function tryTeamsGuestBypass(page, meetingUrl) {
    const guestLabels = [
...
// Cleanup
// ─────────────────────────────────────────────────────────────────────────────
async function handleTeamsEnd(browser, ws, meetingId, ffmpeg) {
